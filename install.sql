...
-- -----------------------------------------------------
-- Table `suarezcl_custom`.`pr_product_line`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `suarezcl_custom`.`pr_product_line` (
  `line_id` INT UNSIGNED NOT NULL,
  `product_id` INT UNSIGNED NOT NULL,
  PRIMARY KEY (`line_id`, `product_id`),
  INDEX `fk_pr_line_has_pr_product_pr_product1_idx` (`product_id` ASC),
  INDEX `fk_pr_line_has_pr_product_pr_line1_idx` (`line_id` ASC),
  CONSTRAINT `fk_pr_line_has_pr_product_pr_line1`
    FOREIGN KEY (`line_id`)
    REFERENCES `suarezcl_custom`.`pr_line` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_pr_line_has_pr_product_pr_product1`
    FOREIGN KEY (`product_id`)
    REFERENCES `suarezcl_custom`.`pr_product` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
