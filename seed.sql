...
INSERT INTO `pr_product` (`id`, `file_image_id`, `reference`, `enabled`, `price`, `created_at`, `updated_at`, `deleted_at`) VALUES
  (1, 1, 'ab', 1, NULL, '2016-10-19 03:07:00', NULL, NULL),
  (2, 1, 'cd', 1, NULL, '2016-10-19 03:18:00', NULL, NULL);



INSERT INTO `pr_product_line` (`line_id`, `product_id`) VALUES
  (1, 1),
  (2, 1);
